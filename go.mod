...
require (
	...
	github.com/openstack-k8s-operators/ovn-operator/api v0.3.1-0.20240212042601-01b7fd911a35
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/storage v0.3.1-0.20240209144956-bbf3c6e54d4d // indirect
