...
require (
	...
	github.com/openstack-k8s-operators/neutron-operator/api v0.3.0
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/storage v0.3.1-0.20231215134849-9acca0025036 // indirect
