...
type OctaviaSpec struct {
	...
	// +kubebuilder:validation:Optional
	// OctaviaWorker - Spec definition for the Worker service of the Octavia deployment
	OctaviaWorker OctaviaWorkerSpec `json:"OctaviaWorker"`

	// +kubebuilder:validation:Optional
	// OctaviaHousekeeping - Spec definition for the Housekeeping service of the Octavia deployment
	OctaviaHousekeeping OctaviaHousekeepingSpec `json:"OctaviaHousekeeping"`

	// +kubebuilder:validation:Optional
	// OctaviaHealthManager - Spec definition for the HealthManager service of the Octavia deployment
	OctaviaHealthManager OctaviaHealthManagerSpec `json:"OctaviaHealthManager"`
}
...
// OctaviaList contains a list of OctaviaAPI
