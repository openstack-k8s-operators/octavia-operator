...
management network can be examined. The results of running `oc rsh openstack
client openstack network list -f yaml` should include `lb-mgmt-net` and
...
The subnets can be viewed by running `oc rsh openstackclient subnet list -f yaml`:
